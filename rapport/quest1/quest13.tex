...
\end{figure}
%f) Que pouvez-vous dire `a propos du biais, de la variance, de la consistance et de la distri- bution asymptotique de votre estimateur ? Bien justifier votre r ́eponse.
